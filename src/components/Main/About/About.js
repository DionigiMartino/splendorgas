    ...
    return (
        <div className={aboutStyle.cont__about}>
            ...
            <div className={aboutStyle.cont__about_inside}>
                ...
                <p>
                    <b>…A marzo del 2019</b> Lampogas viene ceduta al <b>Gruppo AutoGas</b>, passando sotto il marchio <i>AGN Energia.</i>
                </p>

                <p>
                    <i>Il Gruppo AutoGas</i>, <b>di cui siamo attualmente Partner</b>, è una multiutility che offre un’offerta completa nel settore energetico.
                </p>
                ...
                <p>
                    <i>SplendorGas</i>, <b>grazie ai requisiti</b> <i>AutoGas</i>, ha l’incredibile <b>vantaggio di approvvigionarsi direttamente dai depositi costieri</b> per offrire e fornire sempre il massimo della <b>qualità con disponibilità continua di GPL.</b> 
                </p>
